...
- **Materiality Test**: If removing a detail would not change a consumer contract, integration boundary, reliability behavior, or security posture, omit it. _Example: Include "API returns 429 on rate limit" (consumer impact); exclude "uses exponential backoff internally" (implementation detail)._
...
- **RAI Attribution**: All generated documents include footer:
  ...
  _Generated with GitHub Copilot as directed by [User Name]_
  ```
